...
func NewAsset(baseConfig *config.Config, com *common.Common) echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		if len(viewData.Assets) > 0 && (viewData.Assets[0].ImmichAsset.LivePhotoVideoID != "" || (requestConfig.ExperimentalAlbumVideo && viewData.Assets[0].ImmichAsset.Type == immich.VideoType)) {
